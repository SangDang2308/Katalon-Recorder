...
WebUI.setText(findTestObject('Object Repository/Page_ng k nhp hc - HOCMAI/input_Hoc_emailtxt'), 'sang23082001@gmail.com')
...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_ng k nhp hc - HOCMAI/input_Hoc_passwordtxt'), '8SQVv/p9jVQMXePPXMprIg==')

WebUI.click(findTestObject('Object Repository/Page_ng k nhp hc - HOCMAI/div_mnh mt khu Kh ttMt khu c  di t 8 k t tr_d7a0ce'))

WebUI.setEncryptedText(findTestObject('Object Repository/Page_ng k nhp hc - HOCMAI/input_Hoc_passwordtxt'), 'p4y+y39Ir5PJb2ispxT0Ew==')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_ng k nhp hc - HOCMAI/input_Hoc_repaswordtxt'), 'p4y+y39Ir5PJb2ispxT0Ew==')
