...
WebUI.setText(findTestObject('Object Repository/Page_ng k nhp hc - HOCMAI/input_Hoc_emailtxt'), 'sangdang2308@gmail.com')

WebUI.setText(findTestObject('Object Repository/Page_ng k nhp hc - HOCMAI/input_Hoc_phonetxt'), '0349775374')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_ng k nhp hc - HOCMAI/input_Hoc_passwordtxt'), 'NQVT2Jd9NEcGvnbAhj+bWg==')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_ng k nhp hc - HOCMAI/input_Hoc_repaswordtxt'), 'NQVT2Jd9NEdgT8Ctg/nV6Q==')
